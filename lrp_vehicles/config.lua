...
Config.VehicleLockKey   = Config.Keys['L']
Config.LeftTurnSignal   = Config.Keys['[']
Config.RightTurnSignal  = Config.Keys[']']
  
Config.NoBreakingWindow = true

Config.LoJackUpdateTime = 15000 -- in ms