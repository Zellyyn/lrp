...
--end)
--
--RegisterServerEvent('lrp:CreditAccount')
--AddEventHandler('lrp:CreditAccount', function(player, account, amount)
--  TriggerClientEvent('lrp:CreditAccount', player, CreditAccount(player, account, amount))
--end)
--
--RegisterServerEvent('lrp:DebitAccount')
--AddEventHandler('lrp:DebitAccount', function(player, account, amount)
--  TriggerClientEvent('lrp:DebitAccount', player, DebitAccount(player, account, amount))
--end)
--
--RegisterNetEvent('lrp:TransferBetweenAccounts')
--AddEventHandler('lrp:TransferBetweenAccounts', function(player, from_account, to_account, amount)
...
--end
--
--function CreditAccount(player, account, amount)
--  local Balance = GetAccountBalance(player, amount) + amount
--  MySQL.Async.execute('UPDATE lrp_account_ledger SET balance=@balance WHERE account=@account AND identifier=@identifier', {
--    ['@identifier'] = GetPlayerIdentifier(player),
--    ['@account'] = account,
--    ['balance'] = Balance
--  }, function(rows)
...
--end
--
--function DebitAccount(player, account, amount)
--  local Balance = GetAccountBalance(player, amount) - amount
--  if Balance  < 0 then
--    return nil
--  else
